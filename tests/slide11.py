...
class RightRiemannSumExample(Scene):
    def construct(self):
        ...
        # Divide the area under the curve into smaller rectangles (Right Riemann Sum)
        rectangles = axes.get_riemann_rectangles(curve, x_range=[0, PI], dx=0.5, color=GREEN, input_sample_type="right")
